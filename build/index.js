...
function tocEdit({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(Fragment, {
    children: [inspectorControls, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
      className: `wb-blocks-toc ${tocClassName} ${sticky ? 'toc-sticky' : ''} ${dualLevel ? "dual-level" : ""}`,
...
const allowedIcons = ["action/arrow_right_alt", "av/play_arrow", "navigation/check", "action/check_circle", "action/check_circle_outline", "action/info", "action/info_outline", "action/help", "action/help_outline", "alert/error", "alert/error_outline", "toggle/star", "action/label_important", "action/label_important_outline", "action/print"];
