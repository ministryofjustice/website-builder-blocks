  ...
  DatePicker.prototype.createCalendar = function () {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      for (let j = 0; j < 7; j++) {
        ...
        $dateButton.setAttribute('class', 'wp-element-button text-left w-9 !py-0 !px-2 !rounded-none not-focus:!bg-transparent not-focus:!text-[var(--colour-foreground,#0b0c0c)] dark:not-focus:!text-[var(--colour-foreground,#ffffff)]');
