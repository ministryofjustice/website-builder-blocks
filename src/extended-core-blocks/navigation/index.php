...
function wb_extend_nav_block($block_content, $block)
{
	...
	if (in_array("is-style-detached", $block_class_array)) {
		...
		$closeSVG =
			'<svg xmlns="http://www.w3.org/2000/svg" class="wb-close-icon" width="24" height="24" aria-hidden="true" focusable="false" viewBox="0 0 24 24" stroke="currentColor"><line x1="4" y1="4" x2="20" y2="20" stroke-width="4"></line><line x1="20" y1="4" x2="4" y2="20" stroke-width="4"></line></svg>';
