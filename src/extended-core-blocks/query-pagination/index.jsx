import { InspectorControls, __experimentalSpacingSizesControl as SpacingSizesControl } from "@wordpress/block-editor";
 ...
 */
const withQueryPaginationGapControl = createHigherOrderComponent(BlockEdit => {
	return props => {
...
addFilter("editor.BlockEdit", "wb_blocks/query-pagination-gap-control", withQueryPaginationGapControl);
