...
addFilter("blocks.registerBlockType", "wb_blocks/post-date-extend-attributes", addAttributes);
...
addFilter("editor.BlockEdit", "wb_blocks/post-date-prefix-controls", addPrefixControl);
