					...
					<PanelBody title="Button arrows" initialOpen={false}>
						...
						>
							<button
								...
								style={{
									outline:
										!attributes.customArrowLeft || attributes.customArrowLeft === ""
											? "8px solid #0ff"
											: "1px solid #ccc",
							...
							<button
								...
								style={{
									outline:
										!attributes.customArrowRight || attributes.customArrowRight === ""
											? "8px solid #0ff"
											: "1px solid #ccc",
							...
							{allowedArrowsLeft.map((data, index) => [
								<button
									...
									style={{
										outline:
											attributes.customArrowLeft === allowedArrowsLeft[index] ? "8px solid #0ff" : "1px solid #ccc",
								...
								<button
									...
									style={{
										outline:
											attributes.customArrowRight === allowedArrowsRight[index] ? "8px solid #0ff" : "1px solid #ccc",
